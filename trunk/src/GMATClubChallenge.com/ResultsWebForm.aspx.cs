...
namespace GMATClubTest.Web
{
	...
	public partial class ResultsWebForm: Page
	{
		...
		protected void beginCalendar_SelectionChanged(object sender, EventArgs e)
		{
			...
			for (int i=0; i<resultsGrid.Items.Count; ++i)
			{
                resultsGrid.Items[i].Cells[5].Text = ((resultsSet.Results[i].TestIsPractice) ? ("<IMG alt=\"\" src=images/status/SEEN.gif>") : ("<IMG alt=\"\" src=images/status/ANSWER_IS_CORRECT.gif>"));
