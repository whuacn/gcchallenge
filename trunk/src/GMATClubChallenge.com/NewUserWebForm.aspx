            ...
            <table border="0" style="text-align: left">
                <tr>
                    ...
                    <td style="width: 5px; height: 21px">
                        <asp:TextBox ID="loginTextBox"  runat="server" Width="155px" ></asp:TextBox></td>
                    <td style="width: 5px; height: 21px">
                        <asp:RegularExpressionValidator ID="loginRegularExpressionValidator" runat="server"
                            ControlToValidate="loginTextBox" Display="Dynamic" ErrorMessage="*" ValidationExpression=".{4,100}"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td style="height: 24px">
                        <asp:Label ID="Label2" runat="server" Text="Name"></asp:Label></td>
                    <td style="width: 5px; height: 24px;">
                        <asp:TextBox ID="nameTextBox" runat="server" Width="155px"></asp:TextBox></td>
                    <td style="width: 5px; height: 24px">
                        <asp:RegularExpressionValidator ID="nameRegularExpressionValidator" runat="server" ControlToValidate="loginTextBox"
                            Display="Dynamic" ErrorMessage="*" ValidationExpression=".{4,100}"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Password"></asp:Label></td>
                    <td style="width: 5px; height: 21px">
                        <asp:TextBox ID="passwordTextBox" runat="server" TextMode="Password" Width="155px"></asp:TextBox></td>
                    <td style="width: 5px; height: 21px">
                        <asp:RegularExpressionValidator ID="passwordRegularExpressionValidator" runat="server"
                            ControlToValidate="passwordTextBox" Display="Dynamic" ErrorMessage="*" ValidationExpression=".{4,100}"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="Confirm password"></asp:Label></td>
                    <td style="width: 5px; height: 21px">
                        <asp:TextBox ID="confirmTextBox" runat="server" TextMode="Password" Width="155px"></asp:TextBox></td>
                    <td style="width: 5px; height: 21px">
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="passwordTextBox"
                            ControlToValidate="confirmTextBox" Display="Dynamic" ErrorMessage="*"></asp:CompareValidator></td>
                </tr>
            </table>
            <br />
            <table border="0">
