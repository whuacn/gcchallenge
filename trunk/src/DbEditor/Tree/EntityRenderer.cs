...
namespace GmatClubTest.DbEditor.Tree
{
    ...
    public class EntityRenderer
    {
        public static TreeNode Render(Entity e)
        {
            ...
            Debug.Assert(p != null,
                         String.Format(
                             "Cannot render Entity {0} of type {1}. A visual presentation of such type is unknown.",
        ...
        private EntityRenderer()
        {
            ...
            presentation.Add(typeof (Connection),
                             new Presentation(DATABASE_SQL_ICON, true,
                                              new Presentation.SpecificRenderer(ConnectionRenderer)));
