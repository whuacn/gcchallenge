...
namespace GmatClubTest.DbEditor.BusinessObjects
{
    ...
    {
        public QuantitativeAdaptiveTests(AdaptiveTests parent)
            : base("IsPractice=0 AND QuestionTypeId=" + (int) QuestionType.Type.Quantitative, "Quantitative", parent)
        {
        }
        ...
        internal override bool DoCanAddNewChild(Entity entity)
        {
            ...
            return
                ...
                t.Value.QuestionTypeId == (int) QuestionType.Type.Quantitative;
        }
    }
}