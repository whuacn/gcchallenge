...
namespace GmatClubTest.DbEditor.BusinessObjects
{
	public class Connection: StaticFolder, IDisposable
	{
		...
		private Data.Provider dataProvider = new Provider();
		...
		{
			get {return type;}
			set {type = value; if (type == Type.Access) Name = fileName; else Name = serverName + "." + dbName;}
		}

		public string FileName
		{
			get { return fileName; }
			set { fileName = value; DbType = type; }
		}

		public string ServerName
		{
			get { return serverName; }
			set { serverName = value; DbType = type; }
		}

		public string DbName
		{
			get { return dbName; }
			set { dbName = value; DbType = type; }
		}
		...
		internal Data.Provider DataProvider
		{
