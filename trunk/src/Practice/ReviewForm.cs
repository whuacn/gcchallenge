...
namespace GmatClubTest.Practice
{
	...
	public class ReviewForm : Form
	{
		...
		internal System.Windows.Forms.ListView questionStatusListView;
		internal System.Windows.Forms.ListView setStatusListView;
		...
		private void InitializeComponent()
		{
			...
			// 
			this.questionStatusListView.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
			...
			// setStatusListView
			// 
			this.setStatusListView.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
		...
		{
			testController.TransitionOnSelectQuestion(setStatusListView.SelectedItems[0].Index, ((ListView)sender).SelectedItems[0].Index);
		}
		...
		private void setStatusListView_Click(object sender, System.EventArgs e)
		{
			testController.SelectedSetChanged();
		}

		private void setStatusListView_Resize(object sender, System.EventArgs e)
		{
			setStatusListView.Columns[1].Width  = setStatusListView.Width - 5 - (setStatusListView.Columns[0].Width + setStatusListView.Columns[2].Width);
		}

		private void questionStatusListView_Resize(object sender, System.EventArgs e)
		{
			questionStatusListView.Columns[1].Width  = questionStatusListView.Width - 5 - (questionStatusListView.Columns[0].Width + questionStatusListView.Columns[2].Width);
		}

		private void ReviewForm_Load(object sender, System.EventArgs e)
		{
		...
		private void ReviewForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			testController.OnRewievFormClosing();
		}
