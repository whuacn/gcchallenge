...
namespace GmatClubTest.Practice
{
	...
	public class LicenseForm : Form
	{
		...
		private System.Windows.Forms.TextBox licensedBox;
		...
		private void InitializeComponent()
		{
			...
			this.label5.Font = new System.Drawing.Font("Microsoft Sans Serif", 20F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(204)));
			...
			this.label6.Font = new System.Drawing.Font("Microsoft Sans Serif", 20F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(204)));
		...
		{
			string dist = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\GMATClubTest - Practice\\" + openFileDialog.FileName.Substring(openFileDialog.FileName.LastIndexOf("\\"));
		...
		private void browseButton_Click(object sender, EventArgs e)
		{
			if (openFileDialog.ShowDialog() == DialogResult.OK)
			{
				try
				{
					...
					MessageBox.Show("The license is valid.", MainForm.APP_CAPTION, MessageBoxButtons.OK, MessageBoxIcon.Information);
				...
				catch (Exception ex)
				{
					...
					MessageBox.Show("Bad license: " + ex.Message, MainForm.APP_CAPTION, MessageBoxButtons.OK, MessageBoxIcon.Warning);
		...
		private void cancelOkButton_Click(object sender, System.EventArgs e)
		{
		...
		{
			System.Diagnostics.Process.Start("http://" + ((LinkLabel)(sender)).Text);
		}
