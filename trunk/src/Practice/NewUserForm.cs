...
namespace GmatClubTest.Practice
{
	...
	public class NewUserForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.confirmPasswordPictureBox.Image = ((System.Drawing.Image)(resources.GetObject("confirmPasswordPictureBox.Image")));
		...
		private void loginTextBox_TextChanged(object sender, EventArgs e)
		{
			...
			if ((confirmPasswordPictureBox.Visible)&&(passwordPictureBox.Visible)&&(namePictureBox.Visible)&&(loginPictureBox.Visible))
			{
		...
		{
			if ((passwordTextBox.Text == confirmPasswordTextBox.Text)&&(confirmPasswordTextBox.Text !="")&&(confirmPasswordTextBox.Text.ToString().Length >= 4))
			{
				confirmPasswordPictureBox.Show();
		...
		private void createButton_Click(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show("Login '" + loginTextBox.Text.ToString() + "' is already taken. Please, choose another login.", "New user", MessageBoxButtons.OK, MessageBoxIcon.Warning);
		...
		private void NewUserForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			if (cancelCloseFlag)
			{
				e.Cancel = true;
