...
namespace GmatClubTest.Practice
{
	...
	public class TestForm : Form , ITestForm
	{
		...
		internal System.Timers.Timer clockTimer;
		...
		private void VerbalForm_Load(object sender, System.EventArgs e)
		{
		...
		private void answerConfirmButton_Click(object sender, System.EventArgs e)
		{
			answerConfirmButton.Enabled = false;
			nextButton.Enabled = true;
		...
		private void TestForm_HelpRequested(object sender, System.Windows.Forms.HelpEventArgs hlpevent)
		{
			testController.ShowHelp();
		}

		private void sectionExitButton_Click(object sender, System.EventArgs e)
		{
