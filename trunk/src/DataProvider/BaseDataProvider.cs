...
namespace GmatClubTest.DataProvider
{
	public class BaseDataProvider : Component, IDataProvider
	{
		...
		public virtual void Open() {throw new InvalidOperationException("The method must be overriden.");}
		public virtual void Close() {throw new InvalidOperationException("The method must be overriden.");}
		protected virtual DbDataAdapter AdapterUsers {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterUserById {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterTests {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterQuestionById {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterAnswersByQuestionId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterQuestionSetsByTestId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterQuestionsByQuestionSetId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterQuestionsByQuestionSetIdAndZone {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterAnswersByQuestionSetId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterAnswersByQuestionSetIdAndZone {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterResultsByUserIdTimeRange {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterResultsDetailsByResultId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterResultsByResultId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterResultDetailsByResultId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterPassagesToQuestionsByQuestionId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterQuestionSetsExByResultId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		protected virtual DbDataAdapter AdapterResultsDetailsOfSetsByResultId {get {{throw new InvalidOperationException("The method must be overriden.");}}}
		...
		public void GetQuestionsAnswersByQuestionSetIdAndZone(int questionSetId, byte questionZone, QuestionAnswerSet questionsAnswers)
		{
