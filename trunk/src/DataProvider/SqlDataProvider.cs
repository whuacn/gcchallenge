...
namespace GmatClubTest.DataProvider
{
    public class SqlDataProvider : BaseDataProvider
    {
        ...
        private string connectionStr = @"Data Source=localhost\SQLEXPRESS;Initial Catalog=gmat;Integrated Security=True;Pooling=False";
       ...
       public override IDbConnection getConnection()
       {
        ...
        {
           if(null!=connectionStr && ""!=connectionStr )
           {
        ...
        private void InitializeComponent()
        {
           ...
           // sqlConnection
           // 
           this.sqlConnection.ConnectionString = "Data Source=SHARK\\SQLEXPRESS;Initial Catalog=gmat;Integrated Security=True;Poolin" +
               "g=True";
