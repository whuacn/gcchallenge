...
namespace GMATClubTest.Web
{
	...
	{
		protected GmatClubTest.Data.QuestionSetsResultDetailsSet questionSetsResultDetailsSet;
		...
		private void initQuestionStatusTable()
		{
			...
			for (int i=0; i<= questionSetsResultDetailsSet.Answers.Count -1 ; ++i)
			{
				...
				{
					if(questionSetsResultDetailsSet.Answers[j].SetId == questionSetsResultDetailsSet.QuestionSets[selectedSet].Id)
					{
                ...
                // IMG alt="" src="images/gmatclub.jpg"
                 ...
                 tc.Text = ((questionSetsResultDetailsSet.Answers[j].IsCorrect) ? ("<IMG alt=\"\" src=images/status/ANSWER_IS_CORRECT.gif>") : ("<IMG alt=\"\" src=images/status/ANSWER_IS_INCORRECT.gif>"));
                 tc.Enabled = false;
		...
		private void OkImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
		...
		protected void setStutusDataGrid_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			selectedSet = ((System.Web.UI.WebControls.DataGrid)sender).SelectedIndex;
			initQuestionStatusTable();
		}
	}
}
