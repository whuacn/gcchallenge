...
<asp:Content ID="Content1" ContentPlaceHolderID="content" Runat="Server">
   <asp:Panel ID="resources" runat="server" Width="100%" Visible="False">
      <%=description%><hr style="height:1px" />
      <%=resourcelist%></asp:Panel>
   <asp:Panel ID="denied" runat="server" Font-Bold="True" ForeColor="Red"
      Visible="False" Width="100%">
      Access denied!
      <asp:Label ID="deniedLbl" runat="server" Text="" ForeColor="Red"></asp:Label>
      </asp:Panel>
   <asp:Panel ID="pPayAgain" runat="server" Width="100%" Visible="False">
