...
namespace GmatClubTest.DbEditor
{
	...
	public class TypeSelectionForm : Form
	{
		...
		private System.Windows.Forms.RadioButton radioQauantitative;
		private System.Windows.Forms.RadioButton radioVerbal;
		private System.Windows.Forms.RadioButton radioDataSufficiency;
		private System.Windows.Forms.RadioButton radioProblemSolving;
		private System.Windows.Forms.RadioButton radioReadingComprehension;
		private System.Windows.Forms.RadioButton radioSentenceCorrection;
		private System.Windows.Forms.RadioButton radioCriticalReasoning;
		...
		public TypeSelectionForm()
		{
			...
			radioButtonToQuestionType.Add(radioReadingComprehension, new QuestionType(QuestionType.Subtype.ReadingComprehensionQuestionToPassage));
			radioButtonToQuestionType.Add(radioCriticalReasoning, new QuestionType(QuestionType.Subtype.CriticalReasoning));
			radioButtonToQuestionType.Add(radioSentenceCorrection, new QuestionType(QuestionType.Subtype.SentenceCorrection));
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(TypeSelectionForm));
		...
		{
			((RadioButton)this.questionTypeToRadioButton[this.questionType]).Checked = true;
		}
		...
		private void typeCheckedChanged(object sender, System.EventArgs e)
		{
