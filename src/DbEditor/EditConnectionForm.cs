...
namespace GmatClubTest.DbEditor
{
    public class EditConnectionForm : Form
    {
        ...
        private TextBox textBoxSqlUserName;
        ...
        private void InitializeComponent()
        {
            System.Resources.ResourceManager resources =
                new System.Resources.ResourceManager(typeof (EditConnectionForm));
        ...
        private void buttonTestConnection_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Test connection succeed.", ApplicationController.APP_CAPTION, MessageBoxButtons.OK,
                                MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Cannot connect to the database: " + ex.Message, ApplicationController.APP_CAPTION,
