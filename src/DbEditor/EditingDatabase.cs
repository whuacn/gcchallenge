...
namespace GmatClubTest.DbEditor
{
    internal class EditingDatabase
    {
        ...
        private TabbedGroups tabbedGroups = new TabbedGroups();
        ...
        public EditingDatabase(Connection connection)
        {
            ...
            try
            {
                ...
                tabbedGroups.PageCloseRequest += new TabbedGroups.PageCloseRequestHandler(tabbedGroups_PageCloseRequest);

                tabbedGroups.Dock = DockStyle.Fill;
        ...
        public bool Closing()
        {
            foreach (TabPage t in editingQuestionSets.Values)
            {
                try
                {
                    ...
                    {
                        DialogResult r =
                            MessageBox.Show("Save changes to the " + editor.ObjectName + "?",
                                            ApplicationController.APP_CAPTION, MessageBoxButtons.YesNoCancel,
