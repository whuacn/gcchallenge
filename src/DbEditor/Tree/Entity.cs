    ...
    public abstract class Entity : ICloneable
    {
        ...
        public void AddNewChild(Entity entity)
        {
            Debug.Assert(entity.parent == null,
                         String.Format("Cannot add {1} to {0}. The entity already has a parent.", this, entity));
        ...
        {
            if (!CanAddClonedChild(entity))
                throw new Exception(
                    String.Format("Adding of cloned {0} to {1} is forbidden", entity.ToString(), ToString()));
            entity.isClonedEntity = false;
            AddNewChild(entity);
            OnClone(entity);
        }
        ...
        {
            Debug.Assert(entity.parent != null,
                         String.Format("Cannot move {1} to {0}. The entity has no parent.", this, entity));

            if (!CanAddMovingChild(entity))
                throw new Exception(String.Format("Moving of {0} to {1} is forbidden", entity.ToString(), ToString()));
        ...
        public override string ToString()
        {
            if (parent == null)
                ...
                return
                    String.Format("{0} '{1}' (parent: {2} '{3}')", GetType().Name, name, parent.GetType().Name,
                                  parent.Name);
        }
        ...
        public Entity Next()
        {
            ...
            if (thisId < 0 || !(Parent.Children.Count > thisId + 1))
                return null;

            return (Entity) Parent.Children[thisId + 1];
        }
        ...
        public object Clone()
        {
            Entity n = (Entity) MemberwiseClone();
            n.parent = null;
            n.Children = new ArrayList();
            Cloning(n);

            Debug.Assert(n.parent == null, "DoClone() should construct entities with parent == null!");
        ...
        public string Name
        {
            ...
            set
            {
                name = value;
                FixName();
                if (Parent != null) OnAfterRename(this);
            }
        }
