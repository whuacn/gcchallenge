...
namespace GmatClubTest.DbEditor.Tree
{
    ...
    public class ContextMenuBuilder : Component
    {
        ...
        public ContextMenuBuilder(Tree tree)
        {
            ...
            refreshCmd =
                new MenuCommand("Re&fresh", imageList, 5, new EventHandler(ContextMenuHandlers.cmdRefresh_Click));
            addConnectionCmd =
                new MenuCommand("&Add Database", imageList, 6,
                                new EventHandler(ContextMenuHandlers.cmdAddConnection_Click));
            openConnectionCmd =
                new MenuCommand("&Connect", imageList, 7, new EventHandler(ContextMenuHandlers.cmdOpenConnection_Click));
            closeConnectionCmd =
                new MenuCommand("Di&sconnect", imageList, 8,
                                new EventHandler(ContextMenuHandlers.cmdCloseConnection_Click));
            editConnectionCmd =
                new MenuCommand("&Edit", imageList, 11, new EventHandler(ContextMenuHandlers.cmdEditConnection_Click));
        ...
        private void InitializeComponent()
        {
            ...
            ResourceManager resources = new ResourceManager(typeof (ContextMenuBuilder));
