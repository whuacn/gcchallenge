...
namespace GmatClubTest.Practice
{
    ...
    public class ResultsForm : Form
    {
        ...
        private DataGridTextBoxColumn dataGridTextBoxColumn3Text;
        private DataGridTextBoxColumn dataGridTextBoxColumn5;
        private DataGridBoolColumn dataGridBoolColumn4;
        ...
        private void InitializeComponent()
        {
            ...
            // beginDateTimePicker
            // 
            this.beginDateTimePicker.Anchor =
        ...
        private void viewDetailsButton_Click(object sender, EventArgs e)
        {
            if (resultsGrid.CurrentRowIndex != -1)
            {
                ResultDetailsForm resultDetailsForm =
                    new ResultDetailsForm(results.Results[resultsGrid.CurrentRowIndex], manager);
        ...
        private void ResultsForm_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            MainForm.ShowHelpForm(HelpForm.HelpSubtype.Main);
        }

        private void ResultsForm_Closing(object sender, CancelEventArgs e)
        {
        ...
        private void resultsGrid_Resize(object sender, EventArgs e)
        {
