...
namespace GmatClubTest.Practice
{
	...
	public class PracticeForm : Form, ITestForm
	{
		...
		private void PracticeForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			e.Cancel = true;
			testController.ConfirmExit();
		}
		...
		private void PracticeForm_HelpRequested(object sender, System.Windows.Forms.HelpEventArgs hlpevent)
		{
			testController.ShowHelp();
		}
