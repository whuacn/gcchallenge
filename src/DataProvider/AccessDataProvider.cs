...
namespace GmatClubTest.DataProvider
{
    public class AccessDataProvider : BaseDataProvider
    {
        ...
        private OleDbDataAdapter adapterPassagesToQuestionsByQuestionId;
        private OleDbCommand oleDbSelectPassagesToQuestionsByQuestionId;
        private OleDbDataAdapter adapterQuestionSetsByTestId;
        ...
        private OleDbDataAdapter adapterQuestionsByQuestionSetIdAndZone;
        private OleDbCommand oleDbSelectQuestionsByQuestionSetIdAndZone;
        private OleDbCommand oleDbSelectCommand2;
        private OleDbDataAdapter adapterAnswersByQuestionSetIdAndZone;
        ...
        private OleDbCommand selectAnswersByQuestionSetIdAndZone;
        private OleDbCommand oleDbSelectCommand5;
        private OleDbDataAdapter adapterResultsDetailsOfSetsByResultId;
        ...
        private OleDbDataAdapter adapterQuestionSetsExByResultId;
        private OleDbCommand oleDbSelectCommand7;
        private OleDbDataAdapter adapterResultDetailsByResultId;
        ...
        private void InitializeComponent()
        {
            ...
            // sqlSelectCommand5a
            // 
            this.sqlSelectCommand5a.CommandText =
            ...
            this.sqlSelectCommand5a.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@testId", System.Data.OleDb.OleDbType.Integer, 4,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Current,
                                                     "@testId"));
            // 
            // oleDbConnection
            // 
            this.oleDbConnection.ConnectionString =
                @"Jet OLEDB:Global Partial Bulk Ops=2;Jet OLEDB:Registry Path=;Jet OLEDB:Database Locking Mode=1;Data Source=""C:\Projects\GmatClubTest\src\db\GmatClubTest.mdb"";Mode=Share Deny None;Jet OLEDB:Engine Type=5;Provider=""Microsoft.Jet.OLEDB.4.0"";Jet OLEDB:System database=;Jet OLEDB:SFP=False;persist security info=False;Extended Properties=;Jet OLEDB:Compact Without Replica Repair=False;Jet OLEDB:Encrypt Database=True;Jet OLEDB:Create System Database=False;Jet OLEDB:Don't Copy Locale on Compact=False;User ID=Admin;Jet OLEDB:Global Bulk Transactions=1";
            // 
            // adapterUsers
            // 
            ...
            this.adapterUsers.TableMappings.AddRange(new System.Data.Common.DataTableMapping[]
                                                         {
                                                             new System.Data.Common.DataTableMapping("Table", "users",
                                                                                                     new
                                                                                                         System.Data.
                                                                                                         Common.
                                                                                                         DataColumnMapping
            ...
            this.sqlInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Login", System.Data.OleDb.OleDbType.VarChar, 50, "Login"));
            this.sqlInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Password", System.Data.OleDb.OleDbType.VarBinary, 20, "Password"));
            this.sqlInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Name", System.Data.OleDb.OleDbType.VarChar, 50, "Name"));
            // 
            // sqlSelectAllUsers
            // 
            ...
            this.sqlUpdateCommand1.CommandText =
                "UPDATE users SET login = @login, [password] = @password, name = @name WHERE (id =" +
                " @Original_id)";
            ...
            this.sqlDeleteCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            ...
            // sqlInsertCommand2
            // 
            this.sqlInsertCommand2.CommandText =
                "INSERT INTO Tests(Id, Name, IsPractice, Description) VALUES (@Id, @Name, @IsPract" +
                "ice, @Description)";
            this.sqlInsertCommand2.Connection = this.oleDbConnection;
            this.sqlInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Id", System.Data.OleDb.OleDbType.Integer, 0, "Id"));
            this.sqlInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Name", System.Data.OleDb.OleDbType.VarChar, 128, "Name"));
            this.sqlInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@IsPractice", System.Data.OleDb.OleDbType.Boolean, 0, "IsPractice"));
            this.sqlInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Description", System.Data.OleDb.OleDbType.VarChar, 2147483647,
                                                     "Description"));
            // 
            // sqlSelectAll
            // 
            this.sqlSelectAll.CommandText =
                "SELECT Id, Name, IsPractice, Description, QuestionTypeId, QuestionSubtypeId FROM " +
                "Tests";
            this.sqlSelectAll.Connection = this.oleDbConnection;
            // 
            // sqlUpdateCommand2
            // 
            this.sqlUpdateCommand2.CommandText =
                "UPDATE Tests SET Id = @Id, Name = @Name, IsPractice = @IsPractice, Description = " +
                "@Description WHERE (Id = @Original_Id)";
            this.sqlUpdateCommand2.Connection = this.oleDbConnection;
            this.sqlUpdateCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Id", System.Data.OleDb.OleDbType.Integer, 0, "Id"));
            this.sqlUpdateCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Name", System.Data.OleDb.OleDbType.VarChar, 128, "Name"));
            this.sqlUpdateCommand2.Parameters.Add(
            ...
            this.sqlDeleteCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            ...
            // sqlInsertCommand3
            // 
            this.sqlInsertCommand3.CommandText =
                "INSERT INTO Questions(TypeId, SubtypeId, DifficultyLevelId, Text, Picture) VALUES" +
                " (@TypeId, @SubtypeId, @DifficultyLevelId, @Text, @Picture)";
            this.sqlInsertCommand3.Connection = this.oleDbConnection;
            this.sqlInsertCommand3.Parameters.Add(
            ...
            this.sqlInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@DifficultyLevelId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "DifficultyLevelId"));
            this.sqlInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Text", System.Data.OleDb.OleDbType.VarChar, 1024, "Text"));
            this.sqlInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Picture", System.Data.OleDb.OleDbType.VarBinary, 2147483647,
                                                     "Picture"));
            // 
            // sqlSelectCommand3
            // 
            this.sqlSelectCommand3.CommandText =
                "SELECT Id, TypeId, SubtypeId, DifficultyLevelId, Text, Picture FROM Questions WHE" +
                "RE (Id = @Id)";
            ...
            // sqlUpdateCommand3
            // 
            this.sqlUpdateCommand3.CommandText =
                "UPDATE Questions SET TypeId = @TypeId, SubtypeId = @SubtypeId, DifficultyLevelId " +
                "= @DifficultyLevelId, Text = @Text, Picture = @Picture WHERE (Id = @Original_Id)" +
                "";
            this.sqlUpdateCommand3.Connection = this.oleDbConnection;
            this.sqlUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@TypeId", System.Data.OleDb.OleDbType.Integer, 0, "TypeId"));
            this.sqlUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@SubtypeId", System.Data.OleDb.OleDbType.Integer, 0, "SubtypeId"));
            this.sqlUpdateCommand3.Parameters.Add(
            ...
            // sqlDeleteCommand4
            // 
            this.sqlDeleteCommand4.CommandText =
                "DELETE FROM Answers WHERE (QuestionId = @Original_QuestionId) AND (Text = @Origin" +
                "al_Text)";
            this.sqlDeleteCommand4.Connection = this.oleDbConnection;
            this.sqlDeleteCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_QuestionId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "QuestionId",
                                                     System.Data.DataRowVersion.Original, null));
            this.sqlDeleteCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_Text", System.Data.OleDb.OleDbType.VarChar, 512,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Text", System.Data.DataRowVersion.Original,
                                                     null));
            // 
            // sqlInsertCommand4
            // 
            this.sqlInsertCommand4.CommandText =
                "INSERT INTO Answers(QuestionId, Text, IsCorrect, [Order]) VALUES (@QuestionId, @T" +
                "ext, @IsCorrect, @Param1)";
            this.sqlInsertCommand4.Connection = this.oleDbConnection;
            this.sqlInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            this.sqlInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Text", System.Data.OleDb.OleDbType.VarChar, 512, "Text"));
            this.sqlInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@IsCorrect", System.Data.OleDb.OleDbType.Boolean, 0, "IsCorrect"));
            this.sqlInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Param1", System.Data.OleDb.OleDbType.Integer, 0, "Order"));
            // 
            // sqlSelectAnswersByQestionId
            // 
            this.sqlSelectAnswersByQestionId.CommandText =
                "SELECT QuestionId, Text, IsCorrect, [Order] FROM Answers WHERE (QuestionId = @Que" +
                "stionId)";
            this.sqlSelectAnswersByQestionId.Connection = this.oleDbConnection;
            this.sqlSelectAnswersByQestionId.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            // 
            // sqlUpdateCommand4
            // 
            this.sqlUpdateCommand4.CommandText =
                "UPDATE Answers SET QuestionId = @QuestionId, Text = @Text, IsCorrect = @IsCorrect" +
                ", [Order] = @Param2 WHERE (QuestionId = @Original_QuestionId) AND (Text = @Origi" +
                "nal_Text)";
            this.sqlUpdateCommand4.Connection = this.oleDbConnection;
            this.sqlUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            this.sqlUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Text", System.Data.OleDb.OleDbType.VarChar, 512, "Text"));
            this.sqlUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@IsCorrect", System.Data.OleDb.OleDbType.Boolean, 0, "IsCorrect"));
            this.sqlUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Param2", System.Data.OleDb.OleDbType.Integer, 0, "Order"));
            this.sqlUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_QuestionId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "QuestionId",
            ...
            this.sqlDeleteCommand5.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            ...
            this.sqlInsertCommand5.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Login", System.Data.OleDb.OleDbType.VarWChar, 50, "Login"));
            this.sqlInsertCommand5.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Name", System.Data.OleDb.OleDbType.VarWChar, 50, "Name"));
            this.sqlInsertCommand5.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Password", System.Data.OleDb.OleDbType.VarBinary, 20, "Password"));
            // 
            // sqlSelectUserById
            ...
            this.sqlSelectUserById.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Id", System.Data.OleDb.OleDbType.Integer, 0, "Id"));
            // 
            // sqlUpdateCommand5
            // 
            this.sqlUpdateCommand5.CommandText =
                "UPDATE Users SET Login = @Login, [Password] = @Password, Name = @Name WHERE (Id =" +
                " @Original_Id)";
            this.sqlUpdateCommand5.Connection = this.oleDbConnection;
            this.sqlUpdateCommand5.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Login", System.Data.OleDb.OleDbType.VarChar, 50, "Login"));
            this.sqlUpdateCommand5.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Password", System.Data.OleDb.OleDbType.VarBinary, 20, "Password"));
            this.sqlUpdateCommand5.Parameters.Add(
            ...
            this.sqlDeleteCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Delete2_Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            // 
            // sqlInsertCommand8
            // 
            this.sqlInsertCommand8.CommandText =
                "INSERT INTO Questions(TypeId, SubtypeId, DifficultyLevelId, Text, Picture) VALUES" +
                " (@TypeId, @SubtypeId, @DifficultyLevelId, @Text, @Picture)";
            this.sqlInsertCommand8.Connection = this.oleDbConnection;
            this.sqlInsertCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@TypeId", System.Data.OleDb.OleDbType.Integer, 0, "TypeId"));
            this.sqlInsertCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@SubtypeId", System.Data.OleDb.OleDbType.Integer, 0, "SubtypeId"));
            this.sqlInsertCommand8.Parameters.Add(
            ...
            // sqlSelectCommand2
            // 
            this.sqlSelectCommand2.CommandText =
                @"SELECT Questions.Id, Questions.TypeId, Questions.SubtypeId, Questions.DifficultyLevelId, Questions.Text, Questions.Picture FROM (SetsToQuestions INNER JOIN Questions ON SetsToQuestions.QuestionId = Questions.Id) WHERE (SetsToQuestions.SetId = @QuestionSetId)";
            this.sqlSelectCommand2.Connection = this.oleDbConnection;
            this.sqlSelectCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionSetId", System.Data.OleDb.OleDbType.Integer, 0, "SetId"));
            // 
            // sqlUpdateCommand8
            // 
            this.sqlUpdateCommand8.CommandText =
                "UPDATE Questions SET TypeId = @TypeId, SubtypeId = @SubtypeId, DifficultyLevelId " +
                "= @DifficultyLevelId, Text = @Text, Picture = @Picture WHERE (Id = @Update2_Orig" +
                "inal_Id)";
            this.sqlUpdateCommand8.Connection = this.oleDbConnection;
            this.sqlUpdateCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@TypeId", System.Data.OleDb.OleDbType.Integer, 0, "TypeId"));
            this.sqlUpdateCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@SubtypeId", System.Data.OleDb.OleDbType.Integer, 0, "SubtypeId"));
            this.sqlUpdateCommand8.Parameters.Add(
            ...
            this.sqlUpdateCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Picture", System.Data.OleDb.OleDbType.VarBinary, 2147483647,
                                                     "Picture"));
            this.sqlUpdateCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Update2_Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            // 
            ...
            // 
            this.sqlSelectAnswersByQuestionSetId.CommandText =
                "SELECT Answers.* FROM ((Answers INNER JOIN Questions ON Answers.QuestionId = Ques" +
            ...
            this.sqlSelectAnswersByQuestionSetId.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionSetId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "QuestionId"));
            // 
            ...
            // oleDbSelectCommand8
            // 
            this.oleDbSelectCommand8.CommandText =
                @"SELECT Results.Id, Results.UserId, Results.StartTime, Results.EndTime, Results.Score, Tests.Name AS TestName, Tests.IsPractice AS TestIsPractice, Tests.Id AS TestId FROM (Results INNER JOIN Tests ON Results.TestId = Tests.Id) WHERE (Results.UserId = ?) AND (Results.StartTime BETWEEN ? AND ?)";
            this.oleDbSelectCommand8.Connection = this.oleDbConnection;
            this.oleDbSelectCommand8.Parameters.Add(
            ...
            this.oleDbSelectCommand8.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("StartTime1", System.Data.OleDb.OleDbType.Date, 0, "StartTime"));
            // 
            // sqlSelectResultsByUserIdTimeRange
            // 
            this.sqlSelectResultsByUserIdTimeRange.CommandText =
                @"SELECT Results.Id, Results.UserId, Results.StartTime, Results.EndTime, Results.Score, Tests.Name AS TestName, Tests.IsPractice AS TestIsPractice, Tests.Id AS TestId FROM (Results INNER JOIN Tests ON Results.TestId = Tests.Id) WHERE (Results.UserId = @UserId) AND (Results.StartTime BETWEEN @Time1 AND @Time2)";
            this.sqlSelectResultsByUserIdTimeRange.Connection = this.oleDbConnection;
            this.sqlSelectResultsByUserIdTimeRange.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@UserId", System.Data.OleDb.OleDbType.Integer, 0, "UserId"));
            this.sqlSelectResultsByUserIdTimeRange.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Time1", System.Data.OleDb.OleDbType.Date, 0, "StartTime"));
            this.sqlSelectResultsByUserIdTimeRange.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Time2", System.Data.OleDb.OleDbType.Date, 0, "StartTime"));
            // 
            ...
            this.oleDbDeleteCommand3.CommandText =
                "DELETE FROM ResultsDetails WHERE (QuestionId = ?) AND (ResultId = ?) AND (AnswerI" +
                "d = ? OR ? IS NULL AND AnswerId IS NULL) AND (QuestionOrder = ?)";
            this.oleDbDeleteCommand3.Connection = this.oleDbConnection;
            this.oleDbDeleteCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_QuestionId", System.Data.OleDb.OleDbType.Integer, 4,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "QuestionId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbDeleteCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_ResultId", System.Data.OleDb.OleDbType.Integer, 4,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "ResultId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbDeleteCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_AnswerId", System.Data.OleDb.OleDbType.Integer, 4,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "AnswerId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbDeleteCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_AnswerId1", System.Data.OleDb.OleDbType.Integer, 4,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "AnswerId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbDeleteCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_QuestionOrder",
                                                     System.Data.OleDb.OleDbType.UnsignedTinyInt, 1,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "QuestionOrder",
                                                     System.Data.DataRowVersion.Original, null));
            // 
            // oleDbInsertCommand3
            // 
            this.oleDbInsertCommand3.CommandText =
                "INSERT INTO ResultsDetails (ResultId, QuestionId, AnswerId, QuestionOrder) VALUES" +
                " (?, ?, ?, ?);";
            this.oleDbInsertCommand3.Connection = this.oleDbConnection;
            this.oleDbInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("ResultId", System.Data.OleDb.OleDbType.Integer, 0, "ResultId"));
            this.oleDbInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            this.oleDbInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("AnswerId", System.Data.OleDb.OleDbType.Integer, 0, "AnswerId"));
            this.oleDbInsertCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionOrder", System.Data.OleDb.OleDbType.UnsignedTinyInt, 0,
                                                     "QuestionOrder"));
            // 
            // oleDbSelectCommand4
            // 
            this.oleDbSelectCommand4.CommandText =
                "SELECT ResultId, QuestionId, AnswerId, QuestionOrder FROM ResultsDetails WHERE (R" +
                "esultId = ?)";
            this.oleDbSelectCommand4.Connection = this.oleDbConnection;
            this.oleDbSelectCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("ResultId", System.Data.OleDb.OleDbType.Integer, 4, "ResultId"));
            // 
            // oleDbUpdateCommand3
            // 
            this.oleDbUpdateCommand3.CommandText =
                "UPDATE ResultsDetails SET ResultId = ?, QuestionId = ?, AnswerId = ?, QuestionOrd" +
            ...
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("ResultId", System.Data.OleDb.OleDbType.Integer, 0, "ResultId"));
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            this.oleDbUpdateCommand3.Parameters.Add(
            ...
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_QuestionId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     ...
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_ResultId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "ResultId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_AnswerId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "AnswerId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Param44", System.Data.OleDb.OleDbType.Decimal, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "", System.Data.DataRowVersion.Original, null));
            this.oleDbUpdateCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_QuestionOrder",
            ...
            // sqlDeleteCommand7
            // 
            this.sqlDeleteCommand7.CommandText =
                "DELETE FROM ResultsDetails WHERE (QuestionId = @Original_QuestionId) AND (ResultI" +
                "d = @Original_ResultId)";
            this.sqlDeleteCommand7.Connection = this.oleDbConnection;
            this.sqlDeleteCommand7.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_QuestionId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "QuestionId",
                                                     System.Data.DataRowVersion.Original, null));
            ...
            this.sqlInsertCommand7.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@AnswerId", System.Data.OleDb.OleDbType.Integer, 0, "AnswerId"));
            this.sqlInsertCommand7.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionOrder", System.Data.OleDb.OleDbType.TinyInt, 0,
                                                     "QuestionOrder"));
            // 
            // sqlSelectCommand1
            // 
            ...
            // sqlUpdateCommand7
            // 
            this.sqlUpdateCommand7.CommandText =
                "UPDATE ResultsDetails SET ResultId = @ResultId, QuestionId = @QuestionId, AnswerI" +
            ...
            this.sqlUpdateCommand7.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@ResultId", System.Data.OleDb.OleDbType.Integer, 0, "ResultId"));
            this.sqlUpdateCommand7.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            this.sqlUpdateCommand7.Parameters.Add(
            ...
            this.oleDbInsertCommand1.CommandText =
                "INSERT INTO QuestionSets(Name, Description, NumberOfQuestionsToPick, TimeLimit, Q" +
            ...
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Name", System.Data.OleDb.OleDbType.VarWChar, 50, "Name"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Description", System.Data.OleDb.OleDbType.VarWChar, 0,
                                                     "Description"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("NumberOfQuestionsToPick", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "NumberOfQuestionsToPick"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("TimeLimit", System.Data.OleDb.OleDbType.Integer, 0, "TimeLimit"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionTypeId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "QuestionTypeId"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionSubtypeId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "QuestionSubtypeId"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("NumberOfQuestionsInZone1", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "NumberOfQuestionsInZone1"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("NumberOfQuestionsInZone3", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "NumberOfQuestionsInZone3"));
            this.oleDbInsertCommand1.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("NumberOfQuestionsInZone2", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "NumberOfQuestionsInZone2"));
            // 
            // oleDbSelectCommand1
            // 
            ...
            this.oleDbUpdateCommand1.CommandText =
                "UPDATE QuestionSets SET Name = ?, Description = ?, NumberOfQuestionsToPick = ?, T" +
            ...
            this.sqlSelectQuestionSetsByTestId.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@testId", System.Data.OleDb.OleDbType.Integer, 0, "Id"));
            // 
                                                                             ...
                                                                             new System.Data.Common.DataColumnMapping[]
                                                                                 {
                                                                                     ...
                                                                                     new
                                                                                         System.Data.Common.
                                                                                         DataColumnMapping("StartTime",
                                                                                                           "StartTime"),
                                                                                     new
                                                                                         System.Data.Common.
                                                                                         DataColumnMapping("EndTime",
                                                                                                           "EndTime"),
                                                                                     new
                                                                                         System.Data.Common.
                                                                                         DataColumnMapping("Score",
                                                                                                           "Score")
                                                                                 })
                                                                     });
            ...
            this.oleDbDeleteCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            ...
            this.oleDbInsertCommand2.CommandText =
                "INSERT INTO Results(UserId, TestId, StartTime, EndTime, Score) VALUES (?, ?, ?, ?" +
                ", ?)";
            this.oleDbInsertCommand2.Connection = this.oleDbConnection;
            this.oleDbInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("UserId", System.Data.OleDb.OleDbType.Integer, 0, "UserId"));
            this.oleDbInsertCommand2.Parameters.Add(
            ...
            this.oleDbInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("StartTime", System.Data.OleDb.OleDbType.Date, 0, "StartTime"));
            this.oleDbInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("EndTime", System.Data.OleDb.OleDbType.Date, 0, "EndTime"));
            this.oleDbInsertCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Score", System.Data.OleDb.OleDbType.Double, 0, "Score"));
            // 
            // oleDbSelectCommand3
            // 
            this.oleDbSelectCommand3.CommandText =
                "SELECT Id, UserId, TestId, StartTime, EndTime, Score FROM Results WHERE (Id = ?)";
            this.oleDbSelectCommand3.Connection = this.oleDbConnection;
            this.oleDbSelectCommand3.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Id", System.Data.OleDb.OleDbType.Integer, 0, "Id"));
            // 
            // oleDbUpdateCommand2
            // 
            this.oleDbUpdateCommand2.CommandText =
                "UPDATE Results SET UserId = ?, TestId = ?, StartTime = ?, EndTime = ?, Score = ? " +
                "WHERE (Id = ?)";
            ...
            this.sqlDeleteCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Original_Id", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "Id", System.Data.DataRowVersion.Original,
                                                     null));
            ...
            // sqlInsertCommand6
            // 
            this.sqlInsertCommand6.CommandText =
                "INSERT INTO Results(UserId, TestId, StartTime, EndTime, Score) VALUES (@UserId, @" +
                "TestId, @StartTime, @EndTime, @Score)";
            this.sqlInsertCommand6.Connection = this.oleDbConnection;
            this.sqlInsertCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@UserId", System.Data.OleDb.OleDbType.Integer, 0, "UserId"));
            this.sqlInsertCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@TestId", System.Data.OleDb.OleDbType.Integer, 0, "TestId"));
            this.sqlInsertCommand6.Parameters.Add(
            ...
            this.sqlInsertCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@EndTime", System.Data.OleDb.OleDbType.Date, 0, "EndTime"));
            this.sqlInsertCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Score", System.Data.OleDb.OleDbType.Integer, 0, "Score"));
            // 
            // sqlSelectResultsByResultId
            // 
            this.sqlSelectResultsByResultId.CommandText =
                "SELECT Id, UserId, TestId, StartTime, EndTime, Score FROM Results WHERE (Id = @Id" +
                ")";
            this.sqlSelectResultsByResultId.Connection = this.oleDbConnection;
            this.sqlSelectResultsByResultId.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@Id", System.Data.OleDb.OleDbType.Integer, 0, "Id"));
            // 
            // sqlUpdateCommand6
            // 
            this.sqlUpdateCommand6.CommandText =
                "UPDATE Results SET UserId = @UserId, TestId = @TestId, StartTime = @StartTime, En" +
                "dTime = @EndTime, Score = @Score WHERE (Id = @Original_Id)";
            this.sqlUpdateCommand6.Connection = this.oleDbConnection;
            this.sqlUpdateCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@UserId", System.Data.OleDb.OleDbType.Integer, 0, "UserId"));
            this.sqlUpdateCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@TestId", System.Data.OleDb.OleDbType.Integer, 0, "TestId"));
            this.sqlUpdateCommand6.Parameters.Add(
            ...
            // oleDbSelectCommand5
            // 
            this.oleDbSelectCommand5.CommandText =
            ...
            // 
            this.oleDbSelectPassagesToQuestionsByQuestionId.CommandText =
                "SELECT PassagesToQuestions.* FROM (PassagesToQuestions INNER JOIN PassagesToQuest" +
            ...
            this.oleDbSelectPassagesToQuestionsByQuestionId.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionId", System.Data.OleDb.OleDbType.Integer, 0, "QuestionId"));
            // 
            ...
            this.oleDbSelectCommand2.CommandText =
                @"SELECT Questions.Id, Questions.TypeId, Questions.SubtypeId, Questions.DifficultyLevelId, Questions.[Text], Questions.Picture FROM (SetsToQuestions INNER JOIN Questions ON SetsToQuestions.QuestionId = Questions.Id) WHERE (SetsToQuestions.SetId = ?) AND (SetsToQuestions.QuestionZone = ?)";
            this.oleDbSelectCommand2.Connection = this.oleDbConnection;
            this.oleDbSelectCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("SetId", System.Data.OleDb.OleDbType.Integer, 0, "SetId"));
            this.oleDbSelectCommand2.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionZone", System.Data.OleDb.OleDbType.UnsignedTinyInt, 0,
                                                     "QuestionZone"));
            // 
            // oleDbSelectQuestionsByQuestionSetIdAndZone
            // 
            this.oleDbSelectQuestionsByQuestionSetIdAndZone.CommandText =
                @"SELECT Questions.Id, Questions.TypeId, Questions.SubtypeId, Questions.DifficultyLevelId, Questions.Text, Questions.Picture FROM (SetsToQuestions INNER JOIN Questions ON SetsToQuestions.QuestionId = Questions.Id) WHERE (SetsToQuestions.SetId = @QuestionSetId)";
            this.oleDbSelectQuestionsByQuestionSetIdAndZone.Connection = this.oleDbConnection;
            this.oleDbSelectQuestionsByQuestionSetIdAndZone.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("@QuestionSetId", System.Data.OleDb.OleDbType.Integer, 0, "SetId"));
            // 
            ...
            // 
            this.selectAnswersByQuestionSetIdAndZone.CommandText =
                "SELECT Answers.* FROM ((Answers INNER JOIN Questions ON Answers.QuestionId = Ques" +
                "tions.Id) INNER JOIN SetsToQuestions ON Questions.Id = SetsToQuestions.QuestionI" +
            ...
            this.selectAnswersByQuestionSetIdAndZone.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("SetId", System.Data.OleDb.OleDbType.Integer, 0, "SetId"));
            this.selectAnswersByQuestionSetIdAndZone.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionZone", System.Data.OleDb.OleDbType.UnsignedTinyInt, 0,
                                                     "QuestionZone"));
            ...
            // oleDbDeleteCommand4
            // 
            this.oleDbDeleteCommand4.CommandText =
                "DELETE FROM ResultsDetailsOfSets WHERE (QuestionSetId = ?) AND (ResultId = ?)";
            this.oleDbDeleteCommand4.Connection = this.oleDbConnection;
            this.oleDbDeleteCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_QuestionSetId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
                                                     ((System.Byte) (0)), "QuestionSetId",
                                                     System.Data.DataRowVersion.Original, null));
            this.oleDbDeleteCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("Original_ResultId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     System.Data.ParameterDirection.Input, false, ((System.Byte) (0)),
            ...
            // oleDbInsertCommand4
            // 
            this.oleDbInsertCommand4.CommandText =
                "INSERT INTO ResultsDetailsOfSets(QuestionSetId, QuestionSetOrder, ResultId, Score" +
                ") VALUES (?, ?, ?, ?)";
            this.oleDbInsertCommand4.Connection = this.oleDbConnection;
            this.oleDbInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionSetId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "QuestionSetId"));
            this.oleDbInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionSetOrder", System.Data.OleDb.OleDbType.UnsignedTinyInt, 0,
                                                     "QuestionSetOrder"));
            this.oleDbInsertCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("ResultId", System.Data.OleDb.OleDbType.Integer, 0, "ResultId"));
            this.oleDbInsertCommand4.Parameters.Add(
            ...
            // oleDbSelectCommand6
            // 
            this.oleDbSelectCommand6.CommandText =
                "SELECT QuestionSetId, QuestionSetOrder, ResultId, Score FROM ResultsDetailsOfSets" +
                " WHERE (ResultId = ?) ORDER BY QuestionSetOrder";
            this.oleDbSelectCommand6.Connection = this.oleDbConnection;
            this.oleDbSelectCommand6.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("ResultId", System.Data.OleDb.OleDbType.Integer, 0, "ResultId"));
            // 
            // oleDbUpdateCommand4
            // 
            this.oleDbUpdateCommand4.CommandText =
                "UPDATE ResultsDetailsOfSets SET QuestionSetId = ?, QuestionSetOrder = ?, ResultId" +
                " = ?, Score = ? WHERE (QuestionSetId = ?) AND (ResultId = ?)";
            this.oleDbUpdateCommand4.Connection = this.oleDbConnection;
            this.oleDbUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionSetId", System.Data.OleDb.OleDbType.Integer, 0,
                                                     "QuestionSetId"));
            this.oleDbUpdateCommand4.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("QuestionSetOrder", System.Data.OleDb.OleDbType.UnsignedTinyInt, 0,
            ...
            this.oleDbSelectCommand7.Parameters.Add(
                new System.Data.OleDb.OleDbParameter("ResultId", System.Data.OleDb.OleDbType.Integer, 0, "ResultId"));
        }
